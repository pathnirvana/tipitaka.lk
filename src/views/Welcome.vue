<template>
  <v-sheet>
    <v-dialog v-model="$store.state.androidBusy" persistent>
      <v-card>
        <div class="d-flex flex-no-wrap justify-space-around align-center">
          ...
          <div>
            <v-card-text>මේ මෘදුකාංගයේ දත්ත තවමත් copy වෙමින් පවතී. මොහොතක් ඉවසන්න. මෙය පළමු ස්ථාපනය කිරීමේදී පමණක් සිදුවේ.</v-card-text>
          </div>
        </div>
      </v-card>
    </v-dialog>
    ...
    <v-banner icon="mdi-alert-circle" color="warning">
      පාලි පෙළ සෝදුපත් තවමත් අවසන් කර නැති බව සලකන්න. අකුරු වැරදි තිබිය හැකිය. පිටු අංක මත ඔබා අදාළ scan පිටුව පරික්ෂා කර බැලිය හැක.
      අටුවා පරිවර්තනයේද පරිවර්තන දෝෂ, මුද්‍රණ දෝෂ සහ පරිවර්තන මග හැරුණු තැන් තිබිය හැක. දෝෂ හමුවුවහොත් නිවැරදි කිරීමට අප වෙත දන්වා එවන්න. pathnirvana@gmail.com
    </v-banner>
        ...
        <v-col cols="12">
          <v-card flat>
            ...
            <v-card-text>
              ...
              පාළි අටුවා ඡට්ඨ සංගායනාවෙන් ද එහි සිංහල පරිවර්තනය බෞද්ධ සංස්කෘත මධ්‍යස්ථාන මුද්‍රණයෙනි. 
      ...
      <v-row>
        <v-col cols="12">
          <v-banner icon="mdi-information" color="info">
            අන්තර්ජාලය නැතිව භාවිතා කල හැකි මෘදුකාංග පහතින් ලබාගන්න. අටුවා සහ iOS මෘදුකාංග ළඟදීම බලාපොරොත්තු වන්න.
          </v-banner>
        </v-col>
      </v-row>
