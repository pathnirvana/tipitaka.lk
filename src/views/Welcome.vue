<template>
  <v-sheet>
    ...
    <v-banner icon="mdi-alert-circle" color="warning">
      මෙම වෙබ් අඩවියේ වැඩ තවමත් අවසන් නොවන අතර විශේෂයෙන්ම පාලි පෙළ සෝදුපත් බලා ඇත්තේ එක් වරක් පමණක් බව සලකන්න. අකුරු වැරදි තිබිය හැකිය. පිටු අංක මත ඔබා අදාළ scan පිටුව පරික්ෂා කර බැලිය හැක.
    </v-banner>
