<template>
  <v-sheet>
    <v-banner icon="mdi-alert-circle" color="warning">
      මෙම වෙබ් අඩවියේ වැඩ තවමත් අවසන් නොවන අතර විශේෂයෙන්ම පාලි පෙළ සෝදුපත් බලා ඇත්තේ එක් වරක් පමණක් බව සලකන්න. අකුරු වැරදි තිබිය හැකිය.
    </v-banner>
    ...
    <v-container fluid>
      ...
      <v-row>
        ...
        <v-col cols="6" sm="3">
          <v-card flat tile class="d-flex">
            <v-img src="thripitakaya.org-logo.jpg"
      ...
      <v-row>
        <v-banner icon="mdi-information" color="info">
           අටුවා, අන්තර්ගතයේ වචන සෙවීම, අන්තර්ජාලය අනවශ්‍ය මෘදුකාංග සහ උපදෙස් සහිත වීඩියෝව ළඟදීම බලාපොරොත්තු වන්න 
        </v-banner>
      </v-row>
    </v-container>
