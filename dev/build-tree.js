...
const tree = {
    ...
    'an-1': [ 'එකකනිපාතො', 'ඒකක නිපාතය', 5, 0, 'an', 'an-1'],
    'an-2': [ 'දුකනිපාතො', 'දුක නිපාතය', 5, 0, 'an', 'an-2'], 
    'an-3': [ 'තිකනිපාතො', 'තික නිපාතය', 5, 0, 'an', 'an-3-1'],
    'an-4': [ 'චතුක්කනිපාතො', 'චතුක්ක නිපාතය', 5, 0, 'an', 'an-4-1'],
    'an-5': [ 'පඤ්චකනිපාතො', 'පඤ්චක නිපාතය', 5, 0, 'an', 'an-5-1'],
    'an-6': [ 'ඡක්කනිපාතො', 'ඡක්ක නිපාතය', 5, 0, 'an', 'an-6-1'],
    'an-7': [ 'සත්තකනිපාතො', 'සත්තක නිපාතය', 5, 0, 'an', 'an-7-1'],
}
